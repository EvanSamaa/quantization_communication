...
if __name__ == "__main__":
    fname_template = "trained_models/aug20th/Schedular_B=5,E=30+relu_VAE+2qbit{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
    ...
    # model = CSI_reconstruction_model_seperate_decoders(M, K, B, 30, N_rf, 6, more=1)
    model = Feedbakk_FDD_model_scheduler(M, K, B, E, N_rf, 6, more=1, qbit=2, output_all=False)
