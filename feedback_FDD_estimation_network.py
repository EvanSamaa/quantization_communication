...
if __name__ == "__main__":
    fname_template = "trained_models/aug19th/B=20E=20+corrected_VAE_feedback+2_layer_per_link_DNN_6_times+MP+reconstructed{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
    ...
    model = Feedbakk_FDD_model_scheduler_morebit(M, K, B, 20, N_rf, 6, more=2, output_all=True)
