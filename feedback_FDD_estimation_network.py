...
def train_step(features, labels, N=None, epoch=0):
    with tf.GradientTape(persistent=True) as tape:
        ...
        loss_4 = 0.1 * tf.keras.losses.CategoricalCrossentropy()(scheduled_output, mask)
...
if __name__ == "__main__":
    ...
    fname_template = "trained_models/Sept23rd/Nrf=4/Nrf={}normaliza_input_0p25CE+distributed_decision+general{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
