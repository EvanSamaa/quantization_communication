...
if __name__ == "__main__":
    ...
    fname_template = "trained_models/Sept 3rd/K=50,M=64/Naive_model_B=64_weight2_for_both_CE_losses/N_rf={}+B64_1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction{}"
    check = 300
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
