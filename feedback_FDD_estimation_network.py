...
if __name__ == "__main__":
    fname_template = "trained_models/Aug27th/512x1_Per_User_Schedular+B4x8E10+fine_grain_CE+MP+reconstruction+no_square{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
    ...
    model = Feedbakk_FDD_model_scheduler_per_user(M, K, B, E, N_rf, 2, more=32, qbit=0, output_all=True)
