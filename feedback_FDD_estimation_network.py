...
def train_step(features, labels, N=None, epoch=0):
    ...
    with tf.GradientTape() as tape:
        ...
        loss_3 = tf.keras.losses.MeanSquaredError()(reconstructed_input, tf.abs(features))/N
...
if __name__ == "__main__":
    fname_template = "trained_models/aug19th/B=20E=30+corrected_VAE_feedback+2_layer_per_link_DNN_6_times+MP+0.02reconstructed{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
