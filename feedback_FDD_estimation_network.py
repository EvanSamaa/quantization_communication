...
def train_step(features, labels, N=None, epoch=0, lr_boost=1.0):
    with tf.GradientTape(persistent=True) as tape:
        ...
        loss_1 = 0
        loss_3 = 30*tf.keras.losses.MeanSquaredError()(reconstructed_input, tf.abs(features))
...
if __name__ == "__main__":
    ...
    fname_template = "trained_models/OCT30/Nrf=4/B=32xemb_size={}feedback{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
        ...
        for i in mores:
            ...
            for epoch in range(EPOCHS):
                ...
                if epoch % check == 0:
                    ...
                    scheduled_output, raw_output, z_qq, z_e, reconstructed_input = model.predict(valid_data, batch_size=5)
