...
def train_step(features, labels, N=None, epoch=0):
    ...
    with tf.GradientTape(persistent=True) as tape:
        ...
        loss_4 = 0
        factor = {1:1.0, 2:1.0, 3:1.0, 4:1.0, 5:1.0, 6:0.01, 7:0.01, 8:0.01}
...
if __name__ == "__main__":
    ...
    fname_template = "trained_models/Sept8th/K=50,M=64/unonstrained_model_1CE_with_different_mask/set_of_weights_3/Nrf={}_1x512_per_linkx6_alt+weighted_double_CE_loss{}"
    check = 300
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
