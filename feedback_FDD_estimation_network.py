...
if __name__ == "__main__":
    fname_template = "trained_models/Aug25th/Scheduler+B4x12E10code_stacking+MP+reconstruction_loss+seperate_commitment_loss{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
    ...
    model = Feedbakk_FDD_model_scheduler(M, K, B, E, N_rf, 6, more=12, qbit=0, output_all=True)
