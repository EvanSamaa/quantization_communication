...
if __name__ == "__main__":
    ...
    fname_template = "trained_models/Sept8th/K=50,M=64/Naive_model_varying_reconstruction_loss/beta{}_1x512_per_linkx6_alt+weighted_CE_loss{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
