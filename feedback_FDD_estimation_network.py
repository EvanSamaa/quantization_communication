...
if __name__ == "__main__":
    fname_template = "trained_models/Aug24th/Scheduler_B=10,E=30,B_t=2,E_t=10+VAE2+noise_injection{}"
    check = 500
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
    ...
    model = Feedbakk_FDD_model_scheduler_VAE2(M, K, B, E, N_rf, 6, B_t=B_t, E_t=E_t, more=1)
