...
if __name__ == "__main__":
    file = "trained_models/Sept8th/K=50,M=64/Naive_model_B=32_CE1_weight_1_retrain/N_rf={}+VAEB=1x32E=4+1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction"
