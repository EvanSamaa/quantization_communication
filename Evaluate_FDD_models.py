...
if __name__ == "__main__":
    file = "trained_models/Sept8th/K=50,M=64/unonstrained_model_1CE_with_different_mask/weight=0.25/Nrf={}_1x512_per_linkx6_alt+weighted_double_CE_loss"
    ...
    for i in mores:
        ...
        # model = partial_feedback_pure_greedy_model_not_perfect_CSI_available(N_rf, 32, 15, M, K, sigma2_n)
        # print(model.summary())
