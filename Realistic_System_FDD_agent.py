...
def grid_search_with_mutex_loss(N_rf = 8):
    ...
    fname_template_template = "trained_models/Feb8th/user_loc1/on_user_loc_0_Nrf={}".format(N_rf)
    ...
    sigma2_n = 1.0
    ############################### generate data ###############################
    valid_data = gen_realistic_data("trained_models/Feb8th/user_loc1/one_hundred_user_config_1.npy", 1000, K, M, Nrf=N_rf)
    ...
    for i in range(0, EPOCHS):
        ...
        train_data = gen_realistic_data("trained_models/Feb8th/user_loc1/one_hundred_user_config_1.npy", N, K, M, Nrf=N_rf)
