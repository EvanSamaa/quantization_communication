...
if __name__ == "__main__":
    ...
    fname_template_from = "trained_models/Sept 3rd/K=50,M=64/Nrf=4_naive_model_weight1_CE1/N_rf=4+B{}_1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction{}"
    fname_template_to = "trained_models/Sept8th/K=50,M=64/Naive_model_Nrf=4_varying_B/N_rf=4+B{}_1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction{}"
    check = 100
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
