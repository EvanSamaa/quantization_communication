...
if __name__ == "__main__":
    ...
    fname_template_from = "trained_models/Sept 3rd/K=50,M=64/Naive_model/N_rf={}+VAEB=1x32E=4+1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction{}"
    fname_template_to = "trained_models/Sept8th/K=50,M=64/Naive_model_B=32_CE1_weight_1_retrain/N_rf={}+VAEB=1x32E=4+1x512_per_linkx6_alt+weighted_double_CE_loss+MP+half_reconstruction{}"
    check = 50
    SUPERVISE_TIME = 0
    training_mode = 2
    swap_delay = check / 2
